...
This objective covers the [Apache][3] web server. There are a few significant
differences between the 2.2.x version of apache that came with RHEL 6 and the 2.4.x version that comes with RHEL 7.
